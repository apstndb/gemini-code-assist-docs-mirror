---
name: documents/developers.google.com/gemini-code-assist/docs/create-aiexclude-file
uri: https://developers.google.com/gemini-code-assist/docs/create-aiexclude-file
...
You can exclude these files through the use of an `.aiexclude` or `.gitignore` file. [Gemini CLI](https://developers.google.com/gemini-code-assist/docs/gemini-cli) users can exclude files by using a [`.geminiignore` file](https://geminicli.com/docs/cli/gemini-ignore/) .
...
To prevent exposure of code that you don't want to be used in the context, you can use branch patterns to [control access to your index](https://developers.google.com/gemini-code-assist/docs/code-customization#configure-code-customization) and use a stable branch, such as `main` .
