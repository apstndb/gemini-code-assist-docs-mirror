---
name: documents/developers.google.com/gemini-code-assist/docs/chat-overview
uri: https://developers.google.com/gemini-code-assist/docs/chat-overview
title: Gemini Code Assist chat features overview
description: An overview of the chat features that Gemini Code Assist supports in the IDE.
...
You can perform the following chat actions with Gemini Code Assist in any of the [supported IDEs](https://developers.google.com/gemini-code-assist/docs/supported-languages#supported_ides) :
  ...
  - [Select a Gemini model](https://developers.google.com/gemini-code-assist/docs/chat-gemini#select-model)
  ...
  - [Specify files and folders in your workspace context](https://developers.google.com/gemini-code-assist/docs/chat-gemini#specify-context)
  ...
  - [Generate a file outline](https://developers.google.com/gemini-code-assist/docs/chat-gemini#outline)
