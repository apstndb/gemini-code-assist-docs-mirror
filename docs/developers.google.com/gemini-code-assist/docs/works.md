---
name: documents/developers.google.com/gemini-code-assist/docs/works
uri: https://developers.google.com/gemini-code-assist/docs/works
title: How Gemini Code Assist works
description: Learn about how Gemini Code Assist generates code and performs source citation.
...
For more information about Gemini Code Assist Standard and Enterprise security controls, see [Security, privacy, and compliance for Gemini Code Assist Standard and Enterprise](https://docs.cloud.google.com/gemini/docs/codeassist/security-privacy-compliance) .
