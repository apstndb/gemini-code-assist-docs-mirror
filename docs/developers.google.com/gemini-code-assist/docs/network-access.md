---
name: documents/developers.google.com/gemini-code-assist/docs/network-access
uri: https://developers.google.com/gemini-code-assist/docs/network-access
title: Control Network Access to Gemini Code Assist with User Domain Restrictions
description: Steps for configuring networks to restrict access to Gemini Code Assist based on user domains.
