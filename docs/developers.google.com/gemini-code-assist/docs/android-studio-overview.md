---
name: documents/developers.google.com/gemini-code-assist/docs/android-studio-overview
uri: https://developers.google.com/gemini-code-assist/docs/android-studio-overview
title: Gemini in Android Studio
description: Provides an overview of the features available for Gemini in Android Studio.
