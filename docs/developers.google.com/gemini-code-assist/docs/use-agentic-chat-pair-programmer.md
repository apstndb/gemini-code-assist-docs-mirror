---
name: documents/developers.google.com/gemini-code-assist/docs/use-agentic-chat-pair-programmer
uri: https://developers.google.com/gemini-code-assist/docs/use-agentic-chat-pair-programmer
title: Use the Gemini Code Assist agent mode
description: Pair program withGemini Code Assist agentic chat.
...
Gemini Code Assist includes different daily [quotas](https://developers.google.com/gemini-code-assist/resources/quotas#quotas-for-agent-mode-gemini-cli) for agentic features, depending on the tier you're in.

If you've exhausted your daily quota for Gemini Code Assist agent mode, you can continue to use the service by providing an API key. You can use either a [Gemini API key](https://ai.google.dev/gemini-api/docs/api-key) or a [Vertex AI API key](https://cloud.google.com/vertex-ai/generative-ai/docs/start/api-keys) .
