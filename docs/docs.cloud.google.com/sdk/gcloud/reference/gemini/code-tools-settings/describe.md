---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/gemini/code-tools-settings/describe
uri: https://docs.cloud.google.com/sdk/gcloud/reference/gemini/code-tools-settings/describe
title: gcloud gemini code-tools-settings describe
...
`gcloud gemini code-tools-settings describe` ( `  CODE_TOOLS_SETTING  ` : `  --location  ` = `  LOCATION  ` ) \[ `  GCLOUD_WIDE_FLAG …  ` \]
...
CodeToolsSetting resource - Name of the resource. The arguments in this group can be used to specify the attributes of this resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways.
