---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/gemini/code-tools-settings/setting-bindings/update
uri: https://docs.cloud.google.com/sdk/gcloud/reference/gemini/code-tools-settings/setting-bindings/update
title: gcloud gemini code-tools-settings setting-bindings update
...
`gcloud gemini code-tools-settings setting-bindings update` ( `  SETTING_BINDING  ` : `  --code-tools-setting  ` = `  CODE_TOOLS_SETTING  ` `  --location  ` = `  LOCATION  ` ) \[ `  --async  ` \] \[ `  --product  ` = `  PRODUCT  ` \] \[ `  --request-id  ` = `  REQUEST_ID  ` \] \[ `  --target  ` = `  TARGET  ` \] \[ `  --labels  ` =\[ `  LABELS  ` , …\] | `  --update-labels  ` =\[ `  UPDATE_LABELS  ` , …\] `  --clear-labels  ` | `  --remove-labels  ` = `  REMOVE_LABELS  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
