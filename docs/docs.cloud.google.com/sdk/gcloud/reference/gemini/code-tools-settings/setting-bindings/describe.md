---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/gemini/code-tools-settings/setting-bindings/describe
uri: https://docs.cloud.google.com/sdk/gcloud/reference/gemini/code-tools-settings/setting-bindings/describe
title: gcloud gemini code-tools-settings setting-bindings describe
...
`gcloud gemini code-tools-settings setting-bindings describe` ( `  SETTING_BINDING  ` : `  --code-tools-setting  ` = `  CODE_TOOLS_SETTING  ` `  --location  ` = `  LOCATION  ` ) \[ `  GCLOUD_WIDE_FLAG …  ` \]
