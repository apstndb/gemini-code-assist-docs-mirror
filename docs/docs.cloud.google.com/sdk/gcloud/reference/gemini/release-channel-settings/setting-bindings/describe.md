---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/gemini/release-channel-settings/setting-bindings/describe
uri: https://docs.cloud.google.com/sdk/gcloud/reference/gemini/release-channel-settings/setting-bindings/describe
title: gcloud gemini release-channel-settings setting-bindings describe
...
`gcloud gemini release-channel-settings setting-bindings describe` ( `  SETTING_BINDING  ` : `  --location  ` = `  LOCATION  ` `  --release-channel-setting  ` = `  RELEASE_CHANNEL_SETTING  ` ) \[ `  GCLOUD_WIDE_FLAG …  ` \]
