---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/gemini/release-channel-settings/setting-bindings/delete
uri: https://docs.cloud.google.com/sdk/gcloud/reference/gemini/release-channel-settings/setting-bindings/delete
title: gcloud gemini release-channel-settings setting-bindings delete
...
`gcloud gemini release-channel-settings setting-bindings delete` ( `  SETTING_BINDING  ` : `  --location  ` = `  LOCATION  ` `  --release-channel-setting  ` = `  RELEASE_CHANNEL_SETTING  ` ) \[ `  --async  ` \] \[ `  --request-id  ` = `  REQUEST_ID  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
