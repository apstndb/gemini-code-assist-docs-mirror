---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/gemini/gemini-gcp-enablement-settings/setting-bindings/create
uri: https://docs.cloud.google.com/sdk/gcloud/reference/gemini/gemini-gcp-enablement-settings/setting-bindings/create
title: gcloud gemini gemini-gcp-enablement-settings setting-bindings create
...
`gcloud gemini gemini-gcp-enablement-settings setting-bindings create` ( `  SETTING_BINDING  ` : `  --gemini-gcp-enablement-setting  ` = `  GEMINI_GCP_ENABLEMENT_SETTING  ` `  --location  ` = `  LOCATION  ` ) `  --target  ` = `  TARGET  ` \[ `  --async  ` \] \[ `  --labels  ` =\[ `  LABELS  ` , …\]\] \[ `  --product  ` = `  PRODUCT  ` \] \[ `  --request-id  ` = `  REQUEST_ID  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
