...
`gcloud gemini gemini-gcp-enablement-settings setting-bindings describe` ( `  SETTING_BINDING  ` : `  --gemini-gcp-enablement-setting  ` = `  GEMINI_GCP_ENABLEMENT_SETTING  ` `  --location  ` = `  LOCATION  ` ) \[ `  GCLOUD_WIDE_FLAG …  ` \]
