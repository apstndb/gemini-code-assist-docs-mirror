---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/gemini/gemini-gcp-enablement-settings/describe
uri: https://docs.cloud.google.com/sdk/gcloud/reference/gemini/gemini-gcp-enablement-settings/describe
title: gcloud gemini gemini-gcp-enablement-settings describe
...
`gcloud gemini gemini-gcp-enablement-settings describe` ( `  GEMINI_GCP_ENABLEMENT_SETTING  ` : `  --location  ` = `  LOCATION  ` ) \[ `  GCLOUD_WIDE_FLAG …  ` \]
...
GeminiGcpEnablementSetting resource - Name of the resource. The arguments in this group can be used to specify the attributes of this resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways.
