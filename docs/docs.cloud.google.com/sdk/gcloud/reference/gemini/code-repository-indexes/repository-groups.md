---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/gemini/code-repository-indexes/repository-groups
uri: https://docs.cloud.google.com/sdk/gcloud/reference/gemini/code-repository-indexes/repository-groups
title: gcloud gemini code-repository-indexes repository-groups
...
`gcloud gemini code-repository-indexes repository-groups` `  COMMAND  ` \[ `  GCLOUD_WIDE_FLAG …  ` \]
