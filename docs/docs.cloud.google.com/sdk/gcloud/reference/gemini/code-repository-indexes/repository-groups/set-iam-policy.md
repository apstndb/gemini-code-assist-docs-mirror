---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/gemini/code-repository-indexes/repository-groups/set-iam-policy
uri: https://docs.cloud.google.com/sdk/gcloud/reference/gemini/code-repository-indexes/repository-groups/set-iam-policy
title: gcloud gemini code-repository-indexes repository-groups set-iam-policy
...
`gcloud gemini code-repository-indexes repository-groups set-iam-policy` sets the IAM policy for a code repository index repository group as defined in a JSON or YAML file.
...
Repository group resource - The repository group for which to set the IAM policy. The arguments in this group can be used to specify the attributes of this resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways.
