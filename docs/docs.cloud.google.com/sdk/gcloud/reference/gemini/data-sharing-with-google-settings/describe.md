---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/gemini/data-sharing-with-google-settings/describe
uri: https://docs.cloud.google.com/sdk/gcloud/reference/gemini/data-sharing-with-google-settings/describe
title: gcloud gemini data-sharing-with-google-settings describe
...
`gcloud gemini data-sharing-with-google-settings describe` ( `  DATA_SHARING_WITH_GOOGLE_SETTING  ` : `  --location  ` = `  LOCATION  ` ) \[ `  GCLOUD_WIDE_FLAG …  ` \]
