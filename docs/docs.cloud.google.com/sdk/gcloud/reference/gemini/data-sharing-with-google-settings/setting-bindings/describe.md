---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/gemini/data-sharing-with-google-settings/setting-bindings/describe
uri: https://docs.cloud.google.com/sdk/gcloud/reference/gemini/data-sharing-with-google-settings/setting-bindings/describe
title: gcloud gemini data-sharing-with-google-settings setting-bindings describe
...
`gcloud gemini data-sharing-with-google-settings setting-bindings describe` ( `  SETTING_BINDING  ` : `  --data-sharing-with-google-setting  ` = `  DATA_SHARING_WITH_GOOGLE_SETTING  ` `  --location  ` = `  LOCATION  ` ) \[ `  GCLOUD_WIDE_FLAG …  ` \]
