---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/gemini/data-sharing-with-google-settings/setting-bindings/create
uri: https://docs.cloud.google.com/sdk/gcloud/reference/gemini/data-sharing-with-google-settings/setting-bindings/create
title: gcloud gemini data-sharing-with-google-settings setting-bindings create
...
`gcloud gemini data-sharing-with-google-settings setting-bindings create` ( `  SETTING_BINDING  ` : `  --data-sharing-with-google-setting  ` = `  DATA_SHARING_WITH_GOOGLE_SETTING  ` `  --location  ` = `  LOCATION  ` ) `  --target  ` = `  TARGET  ` \[ `  --async  ` \] \[ `  --labels  ` =\[ `  LABELS  ` , …\]\] \[ `  --product  ` = `  PRODUCT  ` \] \[ `  --request-id  ` = `  REQUEST_ID  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
