---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/gemini/gibq-observability-settings/setting-bindings/create
uri: https://docs.cloud.google.com/sdk/gcloud/reference/gemini/gibq-observability-settings/setting-bindings/create
title: gcloud gemini gibq-observability-settings setting-bindings create
...
gcloud gemini gibq-observability-settings setting-bindings create - create settingBindings

SYNOPSIS

`gcloud gemini gibq-observability-settings setting-bindings create` ( `  SETTING_BINDING  ` : `  --gibq-observability-setting  ` = `  GIBQ_OBSERVABILITY_SETTING  ` `  --location  ` = `  LOCATION  ` ) `  --target  ` = `  TARGET  ` \[ `  --async  ` \] \[ `  --labels  ` =\[ `  LABELS  ` , …\]\] \[ `  --product  ` = `  PRODUCT  ` \] \[ `  --request-id  ` = `  REQUEST_ID  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
...
To create the settingBinding, run:
    ...
    gcloud gemini gibq-observability-settings setting-bindings create
