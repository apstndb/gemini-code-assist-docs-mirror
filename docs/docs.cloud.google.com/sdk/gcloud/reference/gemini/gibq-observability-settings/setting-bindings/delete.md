---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/gemini/gibq-observability-settings/setting-bindings/delete
uri: https://docs.cloud.google.com/sdk/gcloud/reference/gemini/gibq-observability-settings/setting-bindings/delete
title: gcloud gemini gibq-observability-settings setting-bindings delete
...
gcloud gemini gibq-observability-settings setting-bindings delete - delete settingBindings

SYNOPSIS

`gcloud gemini gibq-observability-settings setting-bindings delete` ( `  SETTING_BINDING  ` : `  --gibq-observability-setting  ` = `  GIBQ_OBSERVABILITY_SETTING  ` `  --location  ` = `  LOCATION  ` ) \[ `  --async  ` \] \[ `  --request-id  ` = `  REQUEST_ID  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
...
To delete the settingBinding, run:
    ...
    gcloud gemini gibq-observability-settings setting-bindings delete
