---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/gemini/gibq-observability-settings/setting-bindings/describe
uri: https://docs.cloud.google.com/sdk/gcloud/reference/gemini/gibq-observability-settings/setting-bindings/describe
title: gcloud gemini gibq-observability-settings setting-bindings describe
...
gcloud gemini gibq-observability-settings setting-bindings describe - describe settingBindings

SYNOPSIS

`gcloud gemini gibq-observability-settings setting-bindings describe` ( `  SETTING_BINDING  ` : `  --gibq-observability-setting  ` = `  GIBQ_OBSERVABILITY_SETTING  ` `  --location  ` = `  LOCATION  ` ) \[ `  GCLOUD_WIDE_FLAG …  ` \]
...
To describe the settingBinding, run:
    ...
    gcloud gemini gibq-observability-settings setting-bindings describe
