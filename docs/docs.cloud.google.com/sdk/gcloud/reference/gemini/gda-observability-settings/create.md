---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/gemini/gda-observability-settings/create
uri: https://docs.cloud.google.com/sdk/gcloud/reference/gemini/gda-observability-settings/create
title: gcloud gemini gda-observability-settings create
...
gcloud gemini gda-observability-settings create - create gdaObservabilitySettings

SYNOPSIS

`gcloud gemini gda-observability-settings create` ( `  GDA_OBSERVABILITY_SETTING  ` : `  --location  ` = `  LOCATION  ` ) \[ `  --labels  ` =\[ `  LABELS  ` , …\]\] \[ `  --request-id  ` = `  REQUEST_ID  ` \] \[ `  --conversational-analytics-setting-feedback-enabled  ` `  --conversational-analytics-setting-logging-enabled  ` `  --conversational-analytics-setting-metrics-enabled  ` `  --conversational-analytics-setting-traces-enabled  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]

DESCRIPTION

Create a gdaObservabilitySetting

EXAMPLES

To create the gdaObservabilitySetting, run:

    gcloud gemini gda-observability-settings create

POSITIONAL ARGUMENTS

GdaObservabilitySetting resource - Identifier. Name of the resource. Format:projects/{project}/locations/{location}/gdaObservabilitySettings/{gda\_observability\_setting} The arguments in this group can be used to specify the attributes of this resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways.
