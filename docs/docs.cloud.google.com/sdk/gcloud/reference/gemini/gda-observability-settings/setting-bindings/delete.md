---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/gemini/gda-observability-settings/setting-bindings/delete
uri: https://docs.cloud.google.com/sdk/gcloud/reference/gemini/gda-observability-settings/setting-bindings/delete
title: gcloud gemini gda-observability-settings setting-bindings delete
...
gcloud gemini gda-observability-settings setting-bindings delete - delete settingBindings

SYNOPSIS

`gcloud gemini gda-observability-settings setting-bindings delete` ( `  SETTING_BINDING  ` : `  --gda-observability-setting  ` = `  GDA_OBSERVABILITY_SETTING  ` `  --location  ` = `  LOCATION  ` ) \[ `  --async  ` \] \[ `  --request-id  ` = `  REQUEST_ID  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
...
To delete the settingBinding, run:
    ...
    gcloud gemini gda-observability-settings setting-bindings delete
