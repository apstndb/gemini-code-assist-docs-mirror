...
`gcloud gemini gda-observability-settings setting-bindings describe` ( `  SETTING_BINDING  ` : `  --gda-observability-setting  ` = `  GDA_OBSERVABILITY_SETTING  ` `  --location  ` = `  LOCATION  ` ) \[ `  GCLOUD_WIDE_FLAG …  ` \]
