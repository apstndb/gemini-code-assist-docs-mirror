---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/gemini/gda-observability-settings/setting-bindings/create
uri: https://docs.cloud.google.com/sdk/gcloud/reference/gemini/gda-observability-settings/setting-bindings/create
title: gcloud gemini gda-observability-settings setting-bindings create
...
gcloud gemini gda-observability-settings setting-bindings create - create settingBindings

SYNOPSIS

`gcloud gemini gda-observability-settings setting-bindings create` ( `  SETTING_BINDING  ` : `  --gda-observability-setting  ` = `  GDA_OBSERVABILITY_SETTING  ` `  --location  ` = `  LOCATION  ` ) `  --target  ` = `  TARGET  ` \[ `  --async  ` \] \[ `  --labels  ` =\[ `  LABELS  ` , …\]\] \[ `  --product  ` = `  PRODUCT  ` \] \[ `  --request-id  ` = `  REQUEST_ID  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
...
To create the settingBinding, run:
    ...
    gcloud gemini gda-observability-settings setting-bindings create
