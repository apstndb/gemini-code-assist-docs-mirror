---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/gemini/logging-settings/create
uri: https://docs.cloud.google.com/sdk/gcloud/reference/gemini/logging-settings/create
title: gcloud gemini logging-settings create
