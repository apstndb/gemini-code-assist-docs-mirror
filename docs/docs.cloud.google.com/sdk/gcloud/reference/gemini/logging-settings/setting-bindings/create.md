---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/gemini/logging-settings/setting-bindings/create
uri: https://docs.cloud.google.com/sdk/gcloud/reference/gemini/logging-settings/setting-bindings/create
title: gcloud gemini logging-settings setting-bindings create
...
`gcloud gemini logging-settings setting-bindings create` ( `  SETTING_BINDING  ` : `  --location  ` = `  LOCATION  ` `  --logging-setting  ` = `  LOGGING_SETTING  ` ) `  --target  ` = `  TARGET  ` \[ `  --async  ` \] \[ `  --labels  ` =\[ `  LABELS  ` , …\]\] \[ `  --product  ` = `  PRODUCT  ` \] \[ `  --request-id  ` = `  REQUEST_ID  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
