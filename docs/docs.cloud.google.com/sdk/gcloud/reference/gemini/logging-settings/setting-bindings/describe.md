---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/gemini/logging-settings/setting-bindings/describe
uri: https://docs.cloud.google.com/sdk/gcloud/reference/gemini/logging-settings/setting-bindings/describe
title: gcloud gemini logging-settings setting-bindings describe
...
`gcloud gemini logging-settings setting-bindings describe` ( `  SETTING_BINDING  ` : `  --location  ` = `  LOCATION  ` `  --logging-setting  ` = `  LOGGING_SETTING  ` ) \[ `  GCLOUD_WIDE_FLAG …  ` \]
