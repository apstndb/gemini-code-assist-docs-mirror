---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/gemini/logging-settings/delete
uri: https://docs.cloud.google.com/sdk/gcloud/reference/gemini/logging-settings/delete
title: gcloud gemini logging-settings delete
...
`gcloud gemini logging-settings delete` ( `  LOGGING_SETTING  ` : `  --location  ` = `  LOCATION  ` ) \[ `  --request-id  ` = `  REQUEST_ID  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
