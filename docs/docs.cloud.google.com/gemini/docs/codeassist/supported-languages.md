---
name: documents/docs.cloud.google.com/gemini/docs/codeassist/supported-languages
uri: https://docs.cloud.google.com/gemini/docs/codeassist/supported-languages
title: Supported languages, IDEs, and interfaces
description: Learn the languages, IDEs, and code infrastructure interfaces that Gemini Code Assist supports.
...
## What's next
  ...
  - Learn how to [set up Gemini Code Assist for a project](https://docs.cloud.google.com/gemini/docs/codeassist/set-up-gemini) .
