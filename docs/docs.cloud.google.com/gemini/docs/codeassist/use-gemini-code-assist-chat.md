---
name: documents/docs.cloud.google.com/gemini/docs/codeassist/use-gemini-code-assist-chat
uri: https://docs.cloud.google.com/gemini/docs/codeassist/use-gemini-code-assist-chat
title: Use the Gemini Code Assist chat
description: Use the Gemini Code Assist chat in the IDE.
data_source: docs.cloud.google.com
---

This document describes how to get AI-powered assistance in the [Gemini Code Assist](https://docs.cloud.google.com/gemini/docs/codeassist/overview) chat in your integrated development environment (IDE).
...
![Gemini Query History in the tool window.](https://docs.cloud.google.com/static/code/docs/vscode/images/gemini-code-assist-query-history.png)
...
For more information on using Gemini Code Assist in the IDE, see [Code with Gemini Code Assist](https://docs.cloud.google.com/gemini/docs/codeassist/write-code-gemini) .
