---
name: documents/docs.cloud.google.com/gemini/docs/codeassist/agent-mode
uri: https://docs.cloud.google.com/gemini/docs/codeassist/agent-mode
...
Agent mode is available in the VS Code and IntelliJ integrated development environments (IDEs). To start using agent mode, see [Use the Gemini Code Assist agent mode](https://docs.cloud.google.com/gemini/docs/codeassist/use-agentic-chat-pair-programmer) .
...
In agent mode, your prompt is sent to the Gemini API with a list of [tools](https://docs.cloud.google.com/gemini/docs/codeassist/agent-mode#tools) that are available. The Gemini API processes the prompt and returns a response. The response might be a direct answer or a request to use an available tool.
...
![Agent mode context drawer.](https://docs.cloud.google.com/static/gemini/images/intellij-agent-mode-welcome-context-drawer.png)
